...
namespace api_x.Controllers
{
    ...
    public class ValuesController : ControllerBase
    {
        ...
        public string List_CEP(string p_nome)
        {
            ...
            string ChaveConexao = "Data Source=10.39.45.44; Initial Catalog=Thiago; User ID=Turma2022;Password=Turma2022@2022";
            ...
            Conexao.Open();
            string wQuery = $"select * from Cliente where Id like  '{p_nome}'";
